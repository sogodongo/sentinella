...
async def lifespan(app: FastAPI):
    logger.info("evals service starting", extra={"env": settings.sentinella_env})
    yield
    logger.info("evals service stopped")


app = FastAPI(
    title="Sentinella Evals Service",
    description="Model evaluation engine for AI inference quality and safety scoring",
    version="0.1.0",
    lifespan=lifespan,
